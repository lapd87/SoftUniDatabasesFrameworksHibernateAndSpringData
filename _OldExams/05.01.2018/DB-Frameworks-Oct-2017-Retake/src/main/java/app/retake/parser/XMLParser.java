...
public class XMLParser implements Parser {
    ...
    public <T> T read(Class<T> objectClass, String fileContent) throws IOException, JAXBException {
        ...
        unmarshaller.setAdapter(new DateTimeReadAdapter());
    ...
    public <T> String write(T object) throws IOException, JAXBException {
        ...
        marshaller.setAdapter(new DateTimeWriteAdapter());
        StringWriter writer = new StringWriter();
        marshaller.marshal(object, writer);
        return writer.toString();
    }

    public class DateTimeReadAdapter extends XmlAdapter<String, Date> {
    ...
    public class DateTimeWriteAdapter extends XmlAdapter<String, Date> {
